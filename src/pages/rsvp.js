  ...
  return (
    <Layout>
      <h1
        ...
        text-[750px] cursive text-[#7baac8]/[0.8] mb-0 pb-0 leading-none"
      >
        RSVP
      </h1>
      <form
        onSubmit={handleSubmit}
        className={`absolute top-[50%] left-[50%] -translate-x-[50%] -translate-y-[50%] w-[90%] sm:w-auto
        bg-white/[0.9] bg-white/[0.9] p-[24px] lg:p-[32px] flex flex-col items-center
        gap-[28px] cursive text-[#7baac8] w-[90%] lg:w-[500px] text-center text-[36px] z-[20]`}
      >
        <div className="max-h-[450px] overflow-y-scroll w-full px-[20px] flex flex-col gap-[20px]">
          <div className="mb-2 w-full">
            <label htmlFor="name" className="block mb-2 font-medium text-gray-700 text-[36px] lg:text-[36px]">
              Name
            </label>
            <input
              type="text"
            ...
            />
            {errors.name && (
              <p className="mt-1 text-[20px] input-font text-[#7baac8]">{errors.name}</p>
            )}
          </div>
          <div className="mb-2 w-full">
            <label htmlFor="email" className="block mb-2 font-medium text-gray-700 text-[36px] lg:text-[40px]">
              Email
            </label>
            <input
              type="email"
            ...
            />
            {errors.email && (
              <p className="mt-1 text-[20px] input-font text-[#7baac8]">{errors.email}</p>
            )}
          </div>
          <div className="mb-2 w-full">
            <label
            ...
            />
            {errors.numGuests && (
              <p className="mt-1 text-[20px] input-font text-[#7baac8]">{errors.numGuests}</p>
            )}
          </div>
          <div className="mb-2 w-full">
            <label
