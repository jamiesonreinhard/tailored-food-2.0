    ...
    <>
      <Layout>
        ...
        <div className="relative w-full h-screen">
          ...
          <div className="absolute top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 text-center text-white z-10">
          ...
          <button onClick={prevImage} className="absolute left-4 top-1/2 transform -translate-y-1/2 z-10 p-2 bg-white bg-opacity-50">
            <img src="/images/icons/left.svg" alt="" />
          </button>
          <button onClick={nextImage} className="absolute right-4 top-1/2 transform -translate-y-1/2 z-10 p-2 bg-white bg-opacity-50">
            <img src="/images/icons/right.svg" alt="" />
          </button>
        </div>

        {/* Theory of Change Section */}
        <section className="pt-[70px] pb-[40px] bg-gray-100 w-full max-w-[1000px] mx-auto">
          <h1 className="text-center text-[48px] font-semibold mb-[60px]">Theory of Change</h1>
        ...
        <section className="py-[70px] bg-gray-100 w-full">
        ...
        {/* Fat footer */}
        <section className="py-[70px] pb-[100px] bg-gray-100 w-full max-w-[1000px] mx-auto">
          <div className="gap-[100px] flex items-start justify-center">
            <div className="flex flex-col gap-[24px]">
              <img src='/images/tf-logo.svg' alt="Tailored Food logo" className="max-w-[400px]" />
