              ...
              <div className="flex flex-col w-full gap-8">
                ...
                <div className="flex flex-col gap-[16px] items-start">
                  ...
                  <p className="p-body-md sm:p-body-lg lg:p-body-lg">
                    Develop, launch, and scale delicious, low-cost, nutritious, locally sourced food products. <a href="/partner" className="text-green">Learn about our partnerships</a>
                  </p>
                </div>
