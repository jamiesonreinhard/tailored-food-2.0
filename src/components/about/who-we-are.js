    ...
    <div className="flex flex-col w-full mx-auto justify-start">
      ...
      <div className="flex flex-col w-[90%] max-w-[1920px] mx-auto pb-[60px] md:pb-[60px]">
        <div className="flex flex-col gap-[20px] md:gap-[36px]">
          ...
          <p className="p-body-lg text-[16px] md:text-[20px]">
            Tailored Food works to eliminate hunger for people living in poverty
            by developing, launching and scaling delicious, low-cost,
            nutritious, locally sourced food products in partnership with
      ...
      <div className="w-full pt-[72px] pb-[34px] bg-primary-50">
        <div className="flex flex-col w-[90%] max-w-[1920px] mx-auto">
          ...
          <div className="flex flex-col gap-[32px]">
            <p className="p-body-lg text-[16px] md:text-[20px]">
              March 23, 2016: At a hospital hit hard by Ebola on the outskirts
              of Monrovia, Liberia, I met with the Head Pediatrician, Dr. Jude.
              Over a long conversation Dr. Jude shared:{" "}
            </p>
            ...
            <p className="p-body-lg text-[16px] md:text-[20px]">
              This was the spark of a multi-year journey dedicated to designing
              and taking to market nutritious delicious low-cost food in
              Liberia. As we started diving further into the landscape of food
              and malnutrition globally, we realized what our team was learning
              each day in Liberia could have far broader implications.
            </p>
            <p className="p-body-lg text-[16px] md:text-[20px]">
              Tailored Food was born to partner with ambitious local nutrition
              entrepreneurs in designing and selling food products to families
              hardest hit by malnutrition, food products that are delicious,
              culturally-relevant, incredibly nutritious, and locally produced.
              Tailored is not a food company, but is a lean social enterprise
              consultancy that partners with local leaders in the markets we
              work. We have produced and sold over 5.2 million meals to the
              lowest-income families over the last five years.
            </p>
            <p className="p-body-lg text-[16px] md:text-[20px]">
      ...
      <div className="flex flex-col w-[90%] max-w-[1920px] mx-auto pt-[60px] pb-[160px]">
          ...
          <div className="flex flex-col gap-[8px] mb-[24px]">
            ...
            <p className="p-body-lg text-[16px] md:text-[20px]">
              <span className="font-bold">
                Multi-year entrepreneur partnerships –{" "}
              </span>
              In collaboration with small-scale entrepreneurs in the countries
              most impacted by malnutrition, we launch and scale nutritious
              low-cost food products. This work is funded by grants Tailored
              Food receives.
            </p>
          </div>
          <div className="flex flex-col gap-[8px]">
            <p className="p-body-lg text-[16px] md:text-[20px]">
              <em className="font-bold">Systems change through:</em>
            </p>
            <p className="p-body-lg text-[16px] md:text-[20px]">
              <span className="font-bold">
                Strategic consulting projects for larger organizations –{" "}
              </span>
              We complete food systems mapping, investment cases and strategic
              partnership building for clients such as UNICEF, the World Food
              Programme, Save the Children and Impossible Foods, resulting in
              nutritious low-cost food that is available to the lowest-income
              families.
            </p>
          </div>
        </div>
        <div className="flex flex-col gap-[20px] md:gap-[36px] mb-[70px]">
          ...
          <div className="flex flex-col gap-[8px]">
            <p className="p-body-lg text-[16px] md:text-[20px]">
              <em className="font-bold">1. Solutions mapping:</em>
            </p>
            <p className="p-body-lg text-[16px] md:text-[20px]">
              Conducting qualitative ethnographic field research to learn from
              stakeholders throughout food systems.
            </p>
          </div>
          <div className="flex flex-col gap-[8px]">
            <p className="p-body-lg text-[16px] md:text-[20px]">
            ...
            <p className="p-body-lg text-[16px] md:text-[20px]">
              We find the most ambitious entrepreneurs and provide them with a
              team of top food industry experts to design, launch and grow
              nutritious low-cost food products in their home markets. We
              provide end-to-end capacity support for their businesses and
              facilitate access to capital in order to scale impact.
            </p>
          </div>
          <div className="flex flex-col gap-[8px]">
            <p className="p-body-lg text-[16px] md:text-[20px]">
            ...
            <p className="p-body-lg text-[16px] md:text-[20px]">
              Provide end-to-end capacity support to businesses and access to
              capital to scale impact.
            </p>
          </div>
          <div className="flex flex-col gap-[8px]">
            <p className="p-body-lg text-[16px] md:text-[20px]">
        ...
        <div className="flex flex-col gap-[20px] md:gap-[36px]">
          ...
          <p className="p-body-lg text-[16px] md:text-[20px]">
            Tailored Food is well-positioned to pioneer an innovative form of
            international development, leveraging its expertise and networks to
            ensure nutritious, delicious, culturally relevant, and low-cost food
            is available to people suffering from malnutrition in their markets
            every day. Our organization will bring product development and
            demand creation expertise that will be unleashed at the policy level
            globally while also being mobilized at the grassroots level in
            partnership with local for and non-profit food organizations.
          </p>
        </div>
      </div>
    </div>
