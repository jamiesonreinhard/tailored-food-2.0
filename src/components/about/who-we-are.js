...
const WhoWeAre = () => {
    ...
    return (
        <div className="flex flex-col w-full mx-auto justify-start">
            ...
            {/* OUR MISSION */}
            <div className="flex flex-col max-w-[1140px] mx-auto pb-[120px]">
                <div className="flex flex-col gap-[36px] mb-[100px]">
                    <h2 className="h2-bold">Our Mission</h2>
                ...
                {/* MAP */}
                <div className="w-[795px] h-[610px] bg-lightGrey mx-auto">
                    <Map />
                </div>
            ...
            <div className="w-full pt-[72px] pb-[34px] bg-primary-50">
                <div className="flex flex-col max-w-[1140px] mx-auto">
                    ...
                    <div className="flex flex-col gap-[32px]">
                        ...
                        <div className="w-[90%] relative bg-white rounded-[30px] px-[76px] py-[52px] mx-auto">
                            <h3 className="h3-bold">I treat malnourished children at my hospital with what UNICEF provides me, but I know most of these kids will die once I send them home. And there is no advice I can give to their mothers - there simply is no nutritious food available in local markets.</h3>
                            <img src="/images/icons/two-thumbs-up.svg" alt="two thumbs up" className="absolute top-0 left-0 -translate-x-1/2" />
                        </div>
            ...
            {/* WHAT / HOW */}
            <div className="flex flex-col max-w-[1140px] mx-auto pt-[60px] pb-[120px]">
                <div className="flex flex-col gap-[36px] mb-[36px]">
                    <h2 className="h2-bold">What We Do</h2>
                ...
                <div className="flex flex-col gap-[36px] mb-[70px]">
                    <h2 className="h2-bold">How We Do It</h2>
                    {/* Cards */}
                    <div className="w-full flex justify-between gap-[36px]">
                        <div className="p-[24px] border border-greyStroke-[1px] w-[310px] rounded-[12px] flex flex-col items-start grow">
                ...
                <div className="flex flex-col gap-[36px]">
                    <h2 className="h2-bold">Why We Succeed</h2>
