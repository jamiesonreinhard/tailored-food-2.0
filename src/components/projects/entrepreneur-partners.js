  ...
  return (
    <div className="w-[90%] max-w-[1920px] flex flex-col mx-auto">
      <p className="p-body-xl text-[14px] md:text-[24px] mb-[24px] md:mb-[80px]">
        Collaborations with small and medium-scale entrepreneurs in the
        countries most impacted by malnutrition, where we design, launch, and
        scale nutritious, delicious low-cost food products.
      </p>
        ...
        <div className="w-full max-w-[800px] py-[28px] md:py-[46px] px-[20px] md:px-[62px] project-card-shadow rounded-[16px] md:rounded-[32px]">
          <div className="flex flex-col w-full max-w-[800px]">
            ...
            {selectedProject?.link && (
              <Link
                href={selectedProject?.partnerWebsite || ""}
                target="_blank"
