                ...
                <div className="flex w-full flex-wrap justify-center lg:justify-start gap-[36px]">
                    {mediaPosts.map((post, index) => (
                        <div key={index} className="max-w-[540px] media-card-shadow rounded-[26px] flex flex-col items-center p-[12px]">
                            <img src={`/images/media/${post.image}`} alt={post.title} className="mb-[16px] h-[310px] w-full object-cover rounded-[26px]" />
                            ...
                            <a href={post.link} target="_blank" className="btn btn-outline-primary gap-[8px] mr-auto mt-auto">
                                Read More
